...
show_next_steps() {
    ...
    printf "       ./bootstrap.sh\n"
    echo ""
    printf "  3. ${CYAN}Symlink project Caddy configs${NC}\n"
    printf "       ln -s /path/to/project/Caddyfile.static caddy-projects/project.caddy\n"
    echo ""
    printf "  4. ${CYAN}Reload Caddy${NC}\n"
    printf "       docker exec system-caddy caddy reload --config /etc/caddy/Caddyfile\n"
    echo ""
